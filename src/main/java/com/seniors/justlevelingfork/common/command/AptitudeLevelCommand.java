...
public class AptitudeLevelCommand {
    ...
    public static int getAptitude(CommandContext<CommandSourceStack> source, ServerPlayer player, String aptitudeKey) {
        ...
        if (player != null && aptitude != null) {
            ...
            source.getSource().sendSuccess(new TranslatableComponent("commands.message.aptitude.get", player.getName().copy().withStyle(ChatFormatting.BOLD), new TextComponent(String.valueOf(capability.getAptitudeLevel(aptitude))).withStyle(ChatFormatting.BOLD), new TranslatableComponent(aptitude.getKey()).withStyle(ChatFormatting.BOLD)), false);
    ...
    public static int setAptitude(CommandContext<CommandSourceStack> source, ServerPlayer player, String aptitudeKey, int setLevel) {
        ...
        if (player != null && aptitude != null) {
            ...
            source.getSource().sendSuccess(new TranslatableComponent("commands.message.aptitude.set", player.getName().copy().withStyle(ChatFormatting.BOLD), new TextComponent(String.valueOf(capability.getAptitudeLevel(aptitude))).withStyle(ChatFormatting.BOLD), new TranslatableComponent(aptitude.getKey()).withStyle(ChatFormatting.BOLD)), false);
