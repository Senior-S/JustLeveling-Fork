...
public class GlobalLimitCommand {
    ...
    private static int execute(CommandContext<CommandSourceStack> command) {
        ...
        if(command.getSource().getEntity() != null
            ...
            command.getSource().sendFailure(new TextComponent("This command can't be called client side!"));
        ...
        command.getSource().sendSuccess(new TextComponent(String.format("Updating playersMaxGlobalLevel, new level: %d", globalLimitLevel)), true);
