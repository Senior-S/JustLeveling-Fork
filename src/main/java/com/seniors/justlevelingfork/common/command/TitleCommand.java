    ...
    public static int setTitle(CommandContext<CommandSourceStack> source, ServerPlayer player, ResourceLocation titleKey, boolean set) {
        ...
        if (player != null && title != null) {
            if (set) {
                ...
                source.getSource().sendSuccess(new TranslatableComponent("commands.message.title.set", player.getName().copy().withStyle(ChatFormatting.BOLD), new TranslatableComponent(title.getKey()).withStyle(ChatFormatting.BOLD)), false);
                ...
                source.getSource().sendSuccess(new TranslatableComponent("commands.message.title.unset", player.getName().copy().withStyle(ChatFormatting.BOLD), new TranslatableComponent(title.getKey()).withStyle(ChatFormatting.BOLD)), false);
            }
