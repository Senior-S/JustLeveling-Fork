...
public class HandlerCommonConfig {
    ...
    @SerialEntry(comment = "Skills disabled by registry name. Use names like one_handed or justlevelingfork:one_handed.")
    @ListGroup(controllerFactory = StringListGroup.class, valueFactory = StringListGroup.class)
    public List<String> disabledSkills = List.of();

    @SerialEntry(comment = "Passives disabled by registry name. Use names like attack_damage or justlevelingfork:attack_damage.")
    @ListGroup(controllerFactory = StringListGroup.class, valueFactory = StringListGroup.class)
