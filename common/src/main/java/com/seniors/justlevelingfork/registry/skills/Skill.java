...
public class Skill {
    ...
    public boolean canSkill() {
        return RegistrySkills.isEnabled(this) && requiredLevel > 0 && AptitudeCapability.get().getToggleSkill(this);
    }

    public boolean canSkill(Player player) {
        return RegistrySkills.isEnabled(this) && requiredLevel > 0 && AptitudeCapability.get(player).getToggleSkill(this);
    }

    public boolean getToggle() {
        return RegistrySkills.isEnabled(this) && this.requiredLevel > 0 && AptitudeCapability.get().getAptitudeLevel(this.aptitude) >= this.requiredLevel;
    }

    public boolean getToggle(Player player) {
        return RegistrySkills.isEnabled(this) && this.requiredLevel > 0 && AptitudeCapability.get(player).getAptitudeLevel(this.aptitude) >= this.requiredLevel;
    }

    public boolean isEnabled() {
        if (!RegistrySkills.isEnabled(this)) return false;
