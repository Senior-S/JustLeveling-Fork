...
public class DynamicConfigSyncCP implements JustLevelingPacket {
    ...
    public DynamicConfigSyncCP(){
        ...
        disabledSkills = HandlerCommonConfig.HANDLER.instance().disabledSkills;
    ...
    public DynamicConfigSyncCP(FriendlyByteBuf buffer){
        ...
        disabledSkills = stringToList(buffer.readUtf());
        disabledPassives = stringToList(buffer.readUtf());
    }
    ...
    public void toBytes(FriendlyByteBuf buffer) {
        ...
        buffer.writeUtf(listToString(disabledSkills));
        buffer.writeUtf(listToString(disabledPassives));
    }
    ...
    public void handle(ServerPlayer sender) {
            ...
            if(localPlayer != null){
                ...
                HandlerCommonConfig.HANDLER.instance().disabledSkills = this.disabledSkills;
